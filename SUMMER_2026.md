...
- Image columns (`target_vocabulary.correct_image_path`, `recall_sentences.image_path`, both with a `*_bucket` sibling) are in place and nullable, awaiting T4's bucket.
