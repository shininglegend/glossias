...
describe("Footer Component", () => {
  it("renders Glossias description and title", () => {
    ...
    expect(
      screen.getByText(/Interactive language learning through immersive stories/i)
    ).toBeInTheDocument();
  });
  ...
  it("renders key navigation and support links", () => {
    ...
    expect(statusLink.getAttribute("href")).toBe("https://status.glossias.org/");
  ...
  it("renders the copyright text", () => {
    render(<Footer />);
    expect(screen.getByText(/Titus M\. All rights reserved\./i)).toBeInTheDocument();
  });
});
