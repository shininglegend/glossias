        ...
        <div className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 leading-relaxed max-w-md mx-auto">
              In this phase, you will listen to the Hebrew narration of the story. 
              When a target vocabulary word is played, the audio will pause and you will complete a quick picture-association quiz.
            </p>
          </div>
