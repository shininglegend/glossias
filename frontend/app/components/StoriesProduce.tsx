  ...
  return (
    <div className="max-w-4xl mx-auto px-5 py-8">
      <header className="mb-8 text-center">
        ...
        <h2 className="text-lg font-medium text-gray-500">Produce Phase</h2>
      </header>

      <div className="bg-white shadow-xl rounded-2xl overflow-hidden border border-gray-100 max-w-2xl mx-auto">
        <div className="p-8">
          <div className="flex items-center justify-center w-16 h-16 bg-purple-50 text-purple-600 rounded-2xl mx-auto mb-6">
            <span className="material-icons text-3xl">edit</span>
          </div>

          <div className="text-center mb-8">
            <h3 className="text-xl font-bold text-gray-900 mb-3">
              Written Production & Grammar
            </h3>
            <p className="text-gray-600 leading-relaxed max-w-md mx-auto">
              In this phase, you will translate two key English segments of the story into Hebrew. 
              After typing your translation, you will see the reference Hebrew version for self-comparison, followed by an explanation of the grammar.
            </p>
          </div>
