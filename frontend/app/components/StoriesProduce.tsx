        ...
        <div className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 leading-relaxed max-w-md mx-auto">
              In this phase, you will translate two key English segments of the
              story into Hebrew. After typing your translation, you will see the
              reference Hebrew version for self-comparison, followed by an
