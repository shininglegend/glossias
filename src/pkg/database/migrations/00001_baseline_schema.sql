...
DROP TABLE IF EXISTS grammar_incorrect_answers CASCADE;
DROP TABLE IF EXISTS vocab_incorrect_answers CASCADE;
DROP TABLE IF EXISTS grammar_correct_answers CASCADE;
DROP TABLE IF EXISTS vocab_correct_answers CASCADE;
DROP TABLE IF EXISTS anonymous_time_tracking CASCADE;
DROP TABLE IF EXISTS user_time_tracking CASCADE;
...
DROP TABLE IF EXISTS line_audio_files CASCADE;
DROP TABLE IF EXISTS line_translations CASCADE;
DROP TABLE IF EXISTS story_lines CASCADE;
DROP TABLE IF EXISTS story_descriptions CASCADE;
DROP TABLE IF EXISTS story_titles CASCADE;
