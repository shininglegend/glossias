...
type Querier interface {
	...
	GetCourseStories(ctx context.Context, courseID pgtype.Int4) ([]GetCourseStoriesRow, error)
	GetCourseUsers(ctx context.Context, courseID int32) ([]GetCourseUsersRow, error)
	...
	GetUserGrammarAccuracyForStory(ctx context.Context, arg GetUserGrammarAccuracyForStoryParams) (GetUserGrammarAccuracyForStoryRow, error)
	...
	GetUserTimeTrackingForStory(ctx context.Context, arg GetUserTimeTrackingForStoryParams) (GetUserTimeTrackingForStoryRow, error)
	...
	GetUserVocabAccuracyForStory(ctx context.Context, arg GetUserVocabAccuracyForStoryParams) (GetUserVocabAccuracyForStoryRow, error)
